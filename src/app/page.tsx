...
export default function SanctuaryHome() {
  ...
  const goddame =
    "Goddame!3013, a Filipino songwriter and rap artist from Norzagaray, Bulacan, has partnered with the Sanctuary App to contribute original soundscapes and music that enhance the app's relaxationexperience. Through this collaboration, Goddame! provides calming instrumental tracks and soothinglyrical compositions, aligning with the app's mission to deliver curated soundscapes for stress reliefand mental well-being. This partnership brings a unique blend of artistry and therapeutic value,enriching the app's offerings with culturally resonant and emotionally uplifting audio content."
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#00203FFF] font-medium">
      ...
      >
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white text-black p-4 rounded-lg shadow-lg">
            <Link href="#" onClick={() => show("homepage")} className="block py-2">
              Home
            </Link>
            <Link href="#" onClick={() => show("aboutpage")} className="block py-2">
              About
            </Link>
            <Link href="#" onClick={() => show("how-it-works")} className="block py-2">
              How it works
            </Link>
            <Link href="#" onClick={() => show("partners")} className="block py-2">
              Our Partner
            </Link>
            <Link href="#" onClick={() => show("contact")} className="block py-2">
              Contact
            </Link>
      ...
      <main className="flex-grow">
        ...
        <div id="aboutpage" className="page" style={{ display: "none" }}>
          <section className="bg-[#edf2f7] text-gray-800 py-16 min-h-screen relative">
            <br />
            <br />
              ...
              <div className="flex flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0 md:space-x-8 relative">
                <div className="w-full md:w-1/2 z-40">
                  ...
                  <p className="text-lg md:text-xl leading-7 mb-6">
                    ...
                    of our users. Sanctuary is more than just a project; it is a testament to the power of
                    collaboration, creativity, and a shared commitment to mental health. We hope to provide a refuge in
                    the digital world where you can unwind, find focus, and connect with a community that understands
                    your needs.
                  </p>
                </div>
          ...
          <section id="partners" className="bg-[#edf2f7] text-gray-800 py-16 min-h-screen relative">
            ...
            <div className="max-w-6xl mx-auto px-4 mt-20">
              ...
              <p className="text-center text-lg md:text-xl mb-8 md:mb-12">
                We are proud to collaborate with organizations that share our commitment to mental health and
                well-being.
              </p>
        ...
        <div id="contact" className="page" style={{ display: "none" }}>
        ...
        <div id="pricing" className="page" style={{ display: "none" }}>
          <section id="pricing" className="bg-[#edf2f7] py-16 relative">
            ...
            <div className="max-w-6xl mx-auto px-4">
              <h2 className="text-4xl md:text-5xl font-bold text-center text-green-500 mb-8">
                Sanctuary Pricing Plans
              </h2>
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-lg shadow-lg p-8">
                  ...
                  <button
                    disabled
                    className="w-full bg-gray-300 text-gray-600 px-4 py-2 rounded-full cursor-not-allowed"
                  >
                    Coming Soon
                  </button>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    href="/documents/Privacy-Policy_Sanctuary.pdf"
                    target="_blank"
                    className="hover:text-green-500 transition duration-300"
                  >
                    Privacy Policy
                ...
                <li>
                  <Link
                    href="/documents/Terms-and-Conditions_Sanctuary.pdf"
                    target="_blank"
                    className="hover:text-green-500 transition duration-300"
                  >
                    Terms & Conditions
